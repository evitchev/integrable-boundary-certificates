"""Spin-15 (weight-16) ad_{I_3} kernel dimension of one cylindrical Solution
at one rational point of the curve, exact, open stack.  Usage:
  cyl_spin15_kdim.py SOL N S     (N, S as fractions a/b)
...
t0 = time.time()
ker = genuine_kernel_mixed(cyl_P4(sol, N, s), gen_mixed_basis(16), N)
